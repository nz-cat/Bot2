...
local Window = redzlib:MakeWindow({
  Title = "👺VTVN Hub [Mod] : Blox Fruits",
  SubTitle = "By VTVNEZGAME",
  SaveFolder = "VTVNEZGAME.HUB"
})

Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://172680716", BackgroundTransparency = 0 },
...
TabDiscord:AddDiscordInvite({
    ...
    Logo = "rbxassetid://172680716",
    Invite = "https://discord.gg/xfkjcZT8E",
})
